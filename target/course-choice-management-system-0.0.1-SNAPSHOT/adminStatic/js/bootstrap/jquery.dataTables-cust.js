...
//				}
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sInfo": "显示第 _START_ 到第 _END_ 条记录，总共 _TOTAL_ 条记录",
			 ...
			 *    } );
			 */
			"sZeroRecords": "<i class='fa fa-warning text-warning'></i> 没有找到符合条件的记录"
		},
	...
	$.extend( DataTable.ext.oPagination, {
		...
		"two_button": {
			...
			"fnInit": function ( oSettings, nPaging, fnCallbackDraw )
			{
				...
				oSettings.oApi._fnBindAction( nPrevious, {action: "上一页"}, fnClickHandler );
				oSettings.oApi._fnBindAction( nNext,     {action: "下一页"},     fnClickHandler );
