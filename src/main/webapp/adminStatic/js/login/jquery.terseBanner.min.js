/* terseBanner - v2.1.3 - https://github.com/happyfreelife/terseBanner - 2016-12-13 */ ! function (a, b) {
    "function" == typeof define && define.amd ? define(b(a, document)) : "undefined" != typeof exports ? module.exports = b(a, document) : (a.terseBanner = a.terseBanner || {}, a.terseBanner.Global = b(a, document))
}(window, function (a, b) {
    var c = {
...
function (a, b) {
    "function" == typeof define && define.amd ? define(function () {
        return b(a, document)
    }) : "undefined" != typeof exports ? module.exports = b(a, document) : (a.terseBanner = a.terseBanner || {}, a.terseBanner.Banner = b(a, document))
}(window, function (a, b) {
    function c(a, b) {
...
function (a, b) {
    ...
    }) : "undefined" != typeof exports ? module.exports = b($, a, document, require("global"), require("banner"), require("default-style"), require("add-element")) : (a.terseBanner = a.terseBanner || {}, b($, a, document, a.terseBanner.Global, a.terseBanner.Banner))
...
function (a, b) {
    "function" == typeof define && define.amd ? define(["global", "banner"], function (c, d) {
        return b($, a, document, c, d)
    }) : "undefined" != typeof exports ? module.exports = b($, a, document, require("global"), require("banner")) : (a.terseBanner = a.terseBanner || {}, b($, a, document, a.terseBanner.Global, a.terseBanner.Banner))
}(window, function (a, b, c, d, e) {
...
function (a, b) {
    "function" == typeof define && define.amd ? define(["global", "banner", "set-style", "bind-animation"], function (c, d) {
        return b($, a, document, c, d)
    }) : "undefined" != typeof exports ? module.exports = b($, a, document, require("global"), require("banner"), require("set-style"), require("bind-animation")) : (a.terseBanner = a.terseBanner || {}, b($, a, document, a.terseBanner.Global, a.terseBanner.Banner))
}(window, function (a, b, c, d, e) {
...
function (a, b) {
    "function" == typeof define && define.amd ? define(["global", "banner", "bind-event"], function (c, d) {
        return b($, a, document, c, d)
    }) : "undefined" != typeof exports ? module.exports = b($, a, document, require("global"), require("banner"), require("bind-event")) : (a.terseBanner = a.terseBanner || {}, b($, a, document, a.terseBanner.Global, a.terseBanner.Banner))
}(window, function (a, b, c, d, e) {
...
function (a, b) {
    "function" == typeof define && define.amd ? define(["global", "banner", "lazyload"], function (c, d) {
        return b($, a, document, c, d)
    }) : "undefined" != typeof exports ? module.exports = b($, a, document, require("global"), require("banner"), require("lazyload")) : (a.terseBanner = a.terseBanner || {}, b($, a, document, a.terseBanner.Global, a.terseBanner.Banner))
}(window, function (a, b, c, d, e) {
...
function (a, b) {
    ...
    e.prototype.play = function () {
        ...
        if (!this.isAnimated) {
            if ($.isNumeric(arguments[0]) && (arguments[0] < 0 || arguments[0] > this.len)) throw new Error("TerseBanner's index overflow!");
    ...
    }, $.fn.terseBanner = function (a) {
        if (d.isLTIE8) throw new Error("terseBanner cannot work under IE8!");
        return this.each(function () {
            var b = $(this).data("terseBanner");
            b ? "prev" === a ? b.switchTo.call(b, "prev") : "next" === a ? b.switchTo.call(b, "next") : $.isNumeric(a) && b.switchTo.call(b, a) : (options = $.extend(!0, {}, $.fn.terseBanner.defaults, "object" == typeof a && a), $(this).data("terseBanner", b = new e(this, options)), b.init())
        })
...
$('label[class=placeholder]').eq(0).css({"top":"-7px"})
$('label[class=placeholder]').eq(1).css({"top":"0px"})
